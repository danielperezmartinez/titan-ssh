 ...
 * [HostAuth][im.gar.titanssh.config.HostAuth] of a host resolves to live
 * credentials at connect time (ADR-0001). It is the write-side counterpart of the
 * read-side [CredentialResolver][im.gar.titanssh.terminal.CredentialResolver]:
 ...
 * key store by
 * [ensureHardwareKey][im.gar.titanssh.ssh.ensureHardwareKey] and referenced only
 * by alias (ADR-0005).
 */
