...
`packageName = "titan-ssh"`, `packageVersion = "1.0.0"` y nada más (ni
`upgradeUuid`, ni iconos, ni módulos, ni metadatos). El Gradle se ejecuta con
el JDK 21 de Android Studio ([[build-toolchain]]); jpackage empaqueta un JRE
recortado de ese JDK.
